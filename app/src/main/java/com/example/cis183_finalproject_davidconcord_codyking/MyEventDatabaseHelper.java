...
public class MyEventDatabaseHelper extends SQLiteOpenHelper
{
    private static final String DATABASE_NAME = "Events.db";
    private static final String TABLE_NAME = "Events";

    public MyEventDatabaseHelper(Context context)
    {
    ...
    public void onCreate(SQLiteDatabase db)
    {
        db.execSQL("CREATE TABLE " + TABLE_NAME + " (eventname TEXT PRIMARY KEY NOT NULL, " +
                "ename TEXT, etime TEXT, edate TEXT, egid TEXT, eventpassword TEXT);");
    }
